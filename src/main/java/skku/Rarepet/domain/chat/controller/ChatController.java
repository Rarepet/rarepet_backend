...
import skku.Rarepet.domain.chat.dto.ChatRoomIdDto;
...
public class ChatController {
    ...
    @PostMapping()
    public ChatRoomIdDto createChatRoom(
    ...
    @GetMapping()
    public List<ChatRoomListResponseDto> findMyAllChatRoom(@SessionAttribute(name = SessionConst.SESSION, required = true) Long id){
      return chatService.findAllChatRoom(id);
    }
}
